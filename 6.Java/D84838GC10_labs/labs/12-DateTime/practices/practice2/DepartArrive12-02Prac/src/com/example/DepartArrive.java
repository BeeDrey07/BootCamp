...
public class DepartArrive {
    ...
    public static void main(String[] args) {
        ...
        ZonedDateTime arriveBOS = departSFO.plusHours(5).plusMinutes(30)
                .toOffsetDateTime().atZoneSameInstant(BOS);
        ...
        ZonedDateTime arriveBLR = departSFO.plusHours(22)
                .toOffsetDateTime().atZoneSameInstant(BLR);
        ...
        System.out.println("Local Time BOS at departure:    " + departTimeAtBOS);
        System.out.println("Flight time: 5 hours and 30 minutes");
        arriveBOS = departSFO.plusHours(5).plusMinutes(30)
                .toOffsetDateTime().atZoneSameInstant(BOS);
        System.out.println("Flight 123 arrives BOS at:  " + arriveBOS);
