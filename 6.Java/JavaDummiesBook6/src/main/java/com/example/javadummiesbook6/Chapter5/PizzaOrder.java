package com.example.javadummiesbook6.Chapter5;
...
public class PizzaOrder extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        chkAnchovies.setOnAction(e -> setChkAnchovies_Click());
    ...
    public void setChkAnchovies_Click() {
        Alert a = new Alert(Alert.AlertType.WARNING, "We don't do anchovies\nYUCK!!!");
        a.setTitle("YUCK!");
        a.showAndWait();
        chkAnchovies.setSelected(false);
    }
